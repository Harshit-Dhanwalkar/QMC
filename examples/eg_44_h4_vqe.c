...
int main(void) {
  ...
  printf("  Step 1: General N-basis-function RHF (from "
         "physics/molecular_hf.c)\n\n");
  ...
  printf("  Step 2: AO -> MO transform, Jordan-Wigner molecular Hamiltonian (4 "
         "spatial orbitals -> 8 spin-orbitals -> 8 qubits, 256x256)\n\n");
