 ...
 * |l,s = 1/2; j,mj>, computed directly from couple_states()'s Clebsch-Gordan
 * expansion into the uncoupled product basis |l,ml>|s,ms>:
 *   <Sz> = \sum_{ml,ms} |<l ml; s ms | j mj>|^2 * ms
 * rather than from the closed-form g_J.
