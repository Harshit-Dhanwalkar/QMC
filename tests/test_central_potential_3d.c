...
2. 3D finite spherical well (l=0): bound-state energies satisfy the
   transcendental condition k*cot(k*a) = -kappa (k=sqrt(2m(E+V0))/hbar,
   kappa=sqrt(-2mE)/hbar, E<0), found here via independent bisection
